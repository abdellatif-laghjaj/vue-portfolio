<template>
  <div
    class="container w-11/12 sm:w-full mx-auto flex items-center justify-center flex-col"
  >
    <!-- Section Title -->
    ...
    <div class="skills-content">
      <p class="skills-text text-center">
        Here are some of my <span class="text-secondary">projects</span> that
      ...
      <div class="flex items-center justify-center">
        <div
          class="tabs tabs-boxed flex items-center justify-between w-[100%] sm:w-80 mt-5"
        >
          <a
            class="tab h-12 font-bold tab-active"
            @click="filterProjects('all')"
            data-cat="all"
            >All</a
          >
          <a
            class="tab h-12 font-bold"
      ...
      <div class="projects flex flex-wrap -m-4 mt-4" v-if="loaded">
        <div
          class="xl:w-1/3 md:w-1/2 p-4 project"
        ...
        >
          <div class="image">
            ...
            <div class="details">
              ...
              <div
                class="tags flex gap-2 items-center justify-center flex-wrap"
              >
                <span
              ...
              <div class="more">
                ...
                <div class="icon-links flex flex-row items-center gap-1">
                  <a
                    :href="project.demo"
                    target="_blank"
                    class="bg-accent p-2 rounded-full"
                    v-if="project.has_demo"
                  >
                    <svg
                      class="w-6 h-6"
                      fill="currentColor"
...
export default {
  ...
  methods: {
    ...
    filterProjects(category) {
      ...
      document
        .querySelector(`[data-cat=${category}]`)
        .classList.add("tab-active");

      if (category === "all") {
        this.getProjects();
      } else {
        this.filtredProjects = this.projects.filter(
...
.project .image:before {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(255, 255, 255, 0.2); /* Adjust the transparency as needed */
  opacity: 0;
